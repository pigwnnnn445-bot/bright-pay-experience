  ...
  if (isAddon) {
    return (
      ...
      >
        ...
        {product.badgeText && (
          <span
            className="absolute top-1 left-1 text-xs font-medium px-2 py-1 rounded-lg rounded-bl-none min-w-6 min-h-6"
        ...
        <p className={cn(
          ...
          selected ? "text-theme-green bg-payment-bg-1/10" : "text-title bg-secondary"
        )}>
          {product.subTitle}
        </p>
      </button>
  ...
  return (
    ...
    >
      ...
      <p className={cn(
        ...
        selected ? "text-payment-text-1 bg-payment-bg-1/10" : "text-title bg-secondary"
      )}>
        {product.subTitle}
      </p>
    </button>
