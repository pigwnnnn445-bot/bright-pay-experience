    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <motion.div
            className="relative z-10 flex w-full max-w-[980px] max-lg:max-w-full h-[650px] max-lg:h-full max-lg:max-h-screen flex-col overflow-hidden rounded-2xl max-lg:rounded-none shadow-modal lg:flex-row"
